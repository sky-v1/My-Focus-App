...
Future<void> saveUserToFirestore(String uid, String username, String email) async {
  ...
  Future<UserModel?> signInWithGoogle() async {
    ...
    try {
      ...
      debugPrint('Google sign-in completed successfully for username: $username');
      return userModel;
  ...
  Future<UserModel?> logInWithEmailPassword(String emailOrUsername, String password) async {
  ...
  Future<bool> initializeEmailSignup(String username, String email, String password) async {
    debugPrint('Initializing email signup for username: $username, email: $email');
    try {
      // Check if username is unique
  ...
  Future<UserModel?> completeEmailSignupWithGoogle() async {
    ...
    try {
      ...
      final googleUser = await _googleSignIn.signIn();
      if (googleUser == null) {
        debugPrint('Google sign-in cancelled by user during email signup completion');
        return null;
      }
  ...
  await saveUserToFirestore(firebaseUser.uid, tempUsername, tempEmail);
      ...
      debugPrint('Email signup with Google completed successfully for username: $tempUsername');
      return userModel;
  ...
  Future<void> _saveUserData(UserModel user) async {
    ...
    if (user.profilePicUrl != null) {
      await _secureStorage.write(key: 'user_profile_pic', value: user.profilePicUrl);
    }
